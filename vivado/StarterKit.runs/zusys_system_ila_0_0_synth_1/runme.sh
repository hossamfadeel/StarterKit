...
HD_PWD='D:/TRENZ_TE0808/TE0808_Ethernet_2018.2/StarterKit/vivado/StarterKit.runs/zusys_system_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zusys_system_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zusys_system_ila_0_0.tcl
