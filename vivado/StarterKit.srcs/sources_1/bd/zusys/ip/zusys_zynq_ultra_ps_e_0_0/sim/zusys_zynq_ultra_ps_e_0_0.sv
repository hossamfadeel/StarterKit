...
//REG DECLARATIONS
      ...
      reg [2 : 0] emio_enet0_speed_mode;
      reg [7 : 0] emio_enet0_gmii_txd;
      reg emio_enet0_gmii_tx_en;
      reg emio_enet0_gmii_tx_er;
      reg emio_enet0_mdio_mdc;
      reg emio_enet0_mdio_o;
      reg emio_enet0_mdio_t;
      reg emio_enet0_tsu_timer_cmp_val;
      reg [93 : 0] emio_enet0_enet_tsu_timer_cnt;
      reg [1 : 0] emio_enet0_dma_bus_width;
      reg dp_audio_ref_clk;
      reg dp_s_axis_audio_tready;
      reg [31 : 0] dp_m_axis_mixed_audio_tdata;
      reg dp_m_axis_mixed_audio_tid;
      reg dp_m_axis_mixed_audio_tvalid;
      reg dp_aux_data_out;
...
import "DPI-C" function void ps8_simulate_single_cycle_dp_s_axis_audio_clk();
import "DPI-C" function void ps8_simulate_single_cycle_dp_audio_ref_clk();
